...
CUDA_VISIBLE_DEVICES=0 python -u $root_dir/src/vlnce_src/eval.py \
    ...
    --eval_json_path $root_dir/dataset/split/data/uav_dataset/seen_valset.json \
    --map_spawn_area_json_path $root_dir/dataset/split/data/meta/map_spawnarea_info.json \
    --object_name_json_path $root_dir/dataset/split/data/meta/object_description.json \
